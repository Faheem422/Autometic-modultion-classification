...
class tx_atif_simple(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Tx Atif Simple")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Tx Atif Simple")
        ...
        self.settings = Qt.QSettings("GNU Radio", "tx_atif_simple")
        ...
        self.payload_size = payload_size = 92
        self.gap = gap = 100
        self.gain = gain = 45
        self.freq = freq = 2.6e9
        self.fine_freq = fine_freq = 0
        self.eb = eb = 0.35
        self.digital_gain = digital_gain = 0.5

        self.constel = constel = digital.constellation_8psk().base()


        ##################################################
        # Blocks
        ##################################################
        self._gain_range = Range(0, 100, 0.5, 45, 200)
        ...
        self._digital_gain_range = Range(0, 1, 0.1, 0.5, 200)
        ...
        self.uhd_usrp_sink_0.set_center_freq(2.8e9, 0)
        ...
        self._freq_range = Range(1e9, 3e9, 100e3, 2.6e9, 200)
        ...
        self.blocks_vector_source_x_2 = blocks.vector_source_b([85,], True, 1, [])
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/khan/Desktop/transmit', False)
        ...
        self.connect((self.blocks_stream_mux_0_0_0, 0), (self.blocks_uchar_to_float_0, 0))
        ...
        self.connect((self.blocks_vector_source_x_2, 0), (self.blocks_stream_mux_0_0_0, 1))
...
def main(top_block_cls=tx_atif_simple, options=None):
